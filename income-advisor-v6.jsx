...
// ── Design tokens ─────────────────────────────────────────────────────────────
const ICON_B64 = "";
...
function EmailVerificationScreen({ email, onResend, onVerified }) {
  ...
  const handleCheckVerified = () => {
    setChecking(true);
    // Simulate checking — replace with real auth.currentUser.reload() + emailVerified check
    setTimeout(() => {
      setChecking(false);
      onVerified(); // In production: only call if emailVerified === true
    }, 1800);
  };
  ...
  return (
    <div style={{ textAlign:"center", padding:"8px 0 24px", animation:"fadeIn 0.4s ease" }}>
      ...
      <p style={{ fontSize:14, fontWeight:700, color:T.primary, marginBottom:24 }}>{email}</p>
      <p style={{ fontSize:12, color:T.muted, lineHeight:1.6, marginBottom:28 }}>
...
export default function App() {
  ...
  const handleSignOut = () => {
    showModal(
      ...
      [
        ...
        { label:"Sign Out", style:"destructive", fn: () => {
          closeModal();
          setIsPremium(false);
          setScreen("landing");
  ...
  const handleDeleteAccount = () => {
    showModal(
      ...
      [
        { label:"Cancel", style:"secondary", fn: closeModal },
        { label:"Delete Permanently", style:"destructive", fn: () => {
          closeModal();
          setTimeout(() => {
            setIsPremium(false);
            setScreen("landing");
          ...
          <div style={{ background:T.surface, borderRadius:26, padding:"28px 22px", border:`1px solid ${T.border}`, boxShadow:"0 24px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.03)", position:"relative", overflow:"hidden" }}>
            ...
            {screen === "nav-tracking" && (
              emailVerified
                ...
                : <EmailVerificationScreen email={userProfile.email} onResend={() => showToast("Verification email sent.", "success")} onVerified={() => { setEmailVerified(true); showToast("Email verified! Welcome to Auro.", "success"); }} />
            )}
            {screen === "nav-chat" && (
              emailVerified
